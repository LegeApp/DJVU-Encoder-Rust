...
// These are the exact values from the DjVu specification
pub const IW_QUANT: [i32; 16] = [
    0x04000, 0x08000, 0x08000, 0x10000, 0x10000, 0x10000, 0x20000, 0x20000, 0x20000, 0x40000,
    0x40000, 0x40000, 0x80000, 0x40000, 0x40000, 0x80000,
];
