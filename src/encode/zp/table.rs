...
pub const DEFAULT_ZP_TABLE: [ZpTableEntry; 256] = [
    ZpTableEntry { p: 0x8000, m: 0x0000, up: 84, dn: 145 },   // 000
    ZpTableEntry { p: 0x8000, m: 0x0000, up: 3, dn: 4 },      // 001
    ZpTableEntry { p: 0x8000, m: 0x0000, up: 4, dn: 3 },      // 002
    ZpTableEntry { p: 0x6bbd, m: 0x10a5, up: 5, dn: 1 },      // 003
    ZpTableEntry { p: 0x6bbd, m: 0x10a5, up: 6, dn: 2 },      // 004
    ZpTableEntry { p: 0x5d45, m: 0x1f28, up: 7, dn: 3 },      // 005
    ZpTableEntry { p: 0x5d45, m: 0x1f28, up: 8, dn: 4 },      // 006
    ZpTableEntry { p: 0x51b9, m: 0x2bd3, up: 9, dn: 5 },      // 007
    ZpTableEntry { p: 0x51b9, m: 0x2bd3, up: 10, dn: 6 },     // 008
    ZpTableEntry { p: 0x4813, m: 0x36e3, up: 11, dn: 7 },     // 009
    ZpTableEntry { p: 0x4813, m: 0x36e3, up: 12, dn: 8 },     // 010
    ZpTableEntry { p: 0x3fd5, m: 0x408c, up: 13, dn: 9 },     // 011
    ZpTableEntry { p: 0x3fd5, m: 0x408c, up: 14, dn: 10 },    // 012
    ZpTableEntry { p: 0x38b1, m: 0x48fd, up: 15, dn: 11 },    // 013
    ZpTableEntry { p: 0x38b1, m: 0x48fd, up: 16, dn: 12 },    // 014
    ZpTableEntry { p: 0x3275, m: 0x505d, up: 17, dn: 13 },    // 015
    ZpTableEntry { p: 0x3275, m: 0x505d, up: 18, dn: 14 },    // 016
    ZpTableEntry { p: 0x2cfd, m: 0x56d0, up: 19, dn: 15 },    // 017
    ZpTableEntry { p: 0x2cfd, m: 0x56d0, up: 20, dn: 16 },    // 018
    ZpTableEntry { p: 0x2825, m: 0x5c71, up: 21, dn: 17 },    // 019
    ZpTableEntry { p: 0x2825, m: 0x5c71, up: 22, dn: 18 },    // 020
    ZpTableEntry { p: 0x23ab, m: 0x615b, up: 23, dn: 19 },    // 021
    ZpTableEntry { p: 0x23ab, m: 0x615b, up: 24, dn: 20 },    // 022
    ZpTableEntry { p: 0x1f87, m: 0x65a5, up: 25, dn: 21 },    // 023
    ZpTableEntry { p: 0x1f87, m: 0x65a5, up: 26, dn: 22 },    // 024
    ZpTableEntry { p: 0x1bbb, m: 0x6962, up: 27, dn: 23 },    // 025
    ZpTableEntry { p: 0x1bbb, m: 0x6962, up: 28, dn: 24 },    // 026
    ZpTableEntry { p: 0x1845, m: 0x6ca2, up: 29, dn: 25 },    // 027
    ZpTableEntry { p: 0x1845, m: 0x6ca2, up: 30, dn: 26 },    // 028
    ZpTableEntry { p: 0x1523, m: 0x6f74, up: 31, dn: 27 },    // 029
    ZpTableEntry { p: 0x1523, m: 0x6f74, up: 32, dn: 28 },    // 030
    ZpTableEntry { p: 0x1253, m: 0x71e6, up: 33, dn: 29 },    // 031
    ZpTableEntry { p: 0x1253, m: 0x71e6, up: 34, dn: 30 },    // 032
    ZpTableEntry { p: 0x0fcf, m: 0x7404, up: 35, dn: 31 },    // 033
    ZpTableEntry { p: 0x0fcf, m: 0x7404, up: 36, dn: 32 },    // 034
    ZpTableEntry { p: 0x0d95, m: 0x75d6, up: 37, dn: 33 },    // 035
    ZpTableEntry { p: 0x0d95, m: 0x75d6, up: 38, dn: 34 },    // 036
    ZpTableEntry { p: 0x0b9d, m: 0x7768, up: 39, dn: 35 },    // 037
    ZpTableEntry { p: 0x0b9d, m: 0x7768, up: 40, dn: 36 },    // 038
    ZpTableEntry { p: 0x09e3, m: 0x78c2, up: 41, dn: 37 },    // 039
    ZpTableEntry { p: 0x09e3, m: 0x78c2, up: 42, dn: 38 },    // 040
    ZpTableEntry { p: 0x0861, m: 0x79ea, up: 43, dn: 39 },    // 041
    ZpTableEntry { p: 0x0861, m: 0x79ea, up: 44, dn: 40 },    // 042
    ZpTableEntry { p: 0x0711, m: 0x7ae7, up: 45, dn: 41 },    // 043
    ZpTableEntry { p: 0x0711, m: 0x7ae7, up: 46, dn: 42 },    // 044
    ZpTableEntry { p: 0x05f1, m: 0x7bbe, up: 47, dn: 43 },    // 045
    ZpTableEntry { p: 0x05f1, m: 0x7bbe, up: 48, dn: 44 },    // 046
    ZpTableEntry { p: 0x04f9, m: 0x7c75, up: 49, dn: 45 },    // 047
    ZpTableEntry { p: 0x04f9, m: 0x7c75, up: 50, dn: 46 },    // 048
    ZpTableEntry { p: 0x0425, m: 0x7d0f, up: 51, dn: 47 },    // 049
    ZpTableEntry { p: 0x0425, m: 0x7d0f, up: 52, dn: 48 },    // 050
    ZpTableEntry { p: 0x0371, m: 0x7d91, up: 53, dn: 49 },    // 051
    ZpTableEntry { p: 0x0371, m: 0x7d91, up: 54, dn: 50 },    // 052
    ZpTableEntry { p: 0x02d9, m: 0x7dfe, up: 55, dn: 51 },    // 053
    ZpTableEntry { p: 0x02d9, m: 0x7dfe, up: 56, dn: 52 },    // 054
    ZpTableEntry { p: 0x0259, m: 0x7e5a, up: 57, dn: 53 },    // 055
    ZpTableEntry { p: 0x0259, m: 0x7e5a, up: 58, dn: 54 },    // 056
    ZpTableEntry { p: 0x01ed, m: 0x7ea6, up: 59, dn: 55 },    // 057
    ZpTableEntry { p: 0x01ed, m: 0x7ea6, up: 60, dn: 56 },    // 058
    ZpTableEntry { p: 0x0193, m: 0x7ee6, up: 61, dn: 57 },    // 059
    ZpTableEntry { p: 0x0193, m: 0x7ee6, up: 62, dn: 58 },    // 060
    ZpTableEntry { p: 0x0149, m: 0x7f1a, up: 63, dn: 59 },    // 061
    ZpTableEntry { p: 0x0149, m: 0x7f1a, up: 64, dn: 60 },    // 062
    ZpTableEntry { p: 0x010b, m: 0x7f45, up: 65, dn: 61 },    // 063
    ZpTableEntry { p: 0x010b, m: 0x7f45, up: 66, dn: 62 },    // 064
    ZpTableEntry { p: 0x00d5, m: 0x7f6b, up: 67, dn: 63 },    // 065
    ZpTableEntry { p: 0x00d5, m: 0x7f6b, up: 68, dn: 64 },    // 066
    ZpTableEntry { p: 0x00a5, m: 0x7f8d, up: 69, dn: 65 },    // 067
    ZpTableEntry { p: 0x00a5, m: 0x7f8d, up: 70, dn: 66 },    // 068
    ZpTableEntry { p: 0x007b, m: 0x7faa, up: 71, dn: 67 },    // 069
    ZpTableEntry { p: 0x007b, m: 0x7faa, up: 72, dn: 68 },    // 070
    ZpTableEntry { p: 0x0057, m: 0x7fc3, up: 73, dn: 69 },    // 071
    ZpTableEntry { p: 0x0057, m: 0x7fc3, up: 74, dn: 70 },    // 072
    ZpTableEntry { p: 0x003b, m: 0x7fd7, up: 75, dn: 71 },    // 073
    ZpTableEntry { p: 0x003b, m: 0x7fd7, up: 76, dn: 72 },    // 074
    ZpTableEntry { p: 0x0023, m: 0x7fe7, up: 77, dn: 73 },    // 075
    ZpTableEntry { p: 0x0023, m: 0x7fe7, up: 78, dn: 74 },    // 076
    ZpTableEntry { p: 0x0013, m: 0x7ff2, up: 79, dn: 75 },    // 077
    ZpTableEntry { p: 0x0013, m: 0x7ff2, up: 80, dn: 76 },    // 078
    ZpTableEntry { p: 0x0007, m: 0x7ffa, up: 81, dn: 77 },    // 079
    ZpTableEntry { p: 0x0007, m: 0x7ffa, up: 82, dn: 78 },    // 080
    ZpTableEntry { p: 0x0001, m: 0x7fff, up: 81, dn: 79 },    // 081
    ZpTableEntry { p: 0x0001, m: 0x7fff, up: 82, dn: 80 },    // 082
	...
	ZpTableEntry { p: 0x0000, m: 0x0000, up: 0, dn: 0 },      // 251: (unused)
    ZpTableEntry { p: 0x0000, m: 0x0000, up: 0, dn: 0 },      // 252: (unused)
    ZpTableEntry { p: 0x0000, m: 0x0000, up: 0, dn: 0 },      // 253: (unused)
    ZpTableEntry { p: 0x0000, m: 0x0000, up: 0, dn: 0 },      // 254: (unused)
    ZpTableEntry { p: 0x0000, m: 0x0000, up: 0, dn: 0 }       // 255: (unused)
];